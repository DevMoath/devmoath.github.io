...
const Preview = () => {
    ...
    const popover = (
        <Popover className="shadow" id="popover-basic">
    ...
    return (
        <div className="mx-1">
            <img alt="Moath Alhajri Logo" className="rounded icon-200" src={icon}/>
            ...
            <p className="my-4 text-left">
                ...
                <a href="https://twitter.com/TamkeenTech" className="ml-1">@TamkeenTech</a>, Creator of
                <a href="https://infosystems.blog" className="ml-1">infosystems.blog</a>
            </p>
            ...
            <div className="d-flex justify-content-center my-4">
                <OverlayTrigger placement="bottom" trigger="" defaultShow={true} overlay={popover}>
